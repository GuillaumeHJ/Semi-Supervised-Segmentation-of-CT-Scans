...
class BridgeLayer_4(nn.Module):
    ...
    def forward(self, inputs):
        ...
        tem3 = tx[:, 6144:7424, :].reshape(B, -1, C*5)  # Correction ici
...
class MISSFormer(nn.Module):
    def __init__(self, num_classes=9, in_ch=3, token_mlp_mode="mix_skip", encoder_pretrained=True):
        ...
        heads = [1, 2, 5, 8]
        d_base_feat_size = 8 #16 for 512 inputsize   7for 224
        ...
        # print("layers", layers)
        # print("in_chan", in_ch)
        # print("token_mlp_mode", token_mlp_mode)
        self.backbone = MiT(256, dims, layers,3, token_mlp_mode)
